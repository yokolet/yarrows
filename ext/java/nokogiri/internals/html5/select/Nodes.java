...
/**
 ...
 {@link nokogiri.internals.html5.nodes.Document DOM}.</p>
...
public class Nodes<T extends Node> extends ArrayList<T> implements org.w3c.dom.NodeList {
    ...
    /**
     ...
     <p>
     Note that this method should not be used to clean user-submitted HTML; rather, use @link nokogiri.internals.html5.safety.Cleaner
     to clean HTML.
