...
Gem::Specification.new do |spec|
  ...
  spec.files = [
    ...
    "ext/java/nokogiri/internals/html5/helper/DataUtil.java",
    "ext/java/nokogiri/internals/html5/helper/TextUtil.java",
    "ext/java/nokogiri/internals/html5/helper/Validate.java",
    "ext/java/nokogiri/internals/html5/helper/ValidationException.java",
    "ext/java/nokogiri/internals/html5/internal/Normalizer.java",
    "ext/java/nokogiri/internals/html5/internal/QuietAppendable.java",
    "ext/java/nokogiri/internals/html5/internal/SharedConstants.java",
    "ext/java/nokogiri/internals/html5/internal/SoftPool.java",
    "ext/java/nokogiri/internals/html5/internal/StringUtil.java",
    "ext/java/nokogiri/internals/html5/nodes/Attribute.java",
    "ext/java/nokogiri/internals/html5/nodes/Attributes.java",
    "ext/java/nokogiri/internals/html5/nodes/CDataNode.java",
    "ext/java/nokogiri/internals/html5/nodes/Comment.java",
    "ext/java/nokogiri/internals/html5/nodes/DataNode.java",
    "ext/java/nokogiri/internals/html5/nodes/Document.java",
    "ext/java/nokogiri/internals/html5/nodes/DocumentFragment.java",
    "ext/java/nokogiri/internals/html5/nodes/DocumentType.java",
    "ext/java/nokogiri/internals/html5/nodes/Element.java",
    ...
    "ext/java/nokogiri/internals/html5/parser/TokenData.java",
    ...
    "ext/java/nokogiri/internals/html5/select/NodeTraversor.java",
    "ext/java/nokogiri/internals/html5/select/NodeVisitor.java",
    "ext/nokogiri/depend",
